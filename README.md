...
- 📈 Focused on Data Analysis, Machine Learning, and Big Data
...
`EDA` `Data Cleaning` `Data Preprocessing` `Feature Engineering` `Feature Selection`

**Machine Learning**

![Scikit-Learn](https://img.shields.io/badge/Scikit--Learn-F7931E?style=flat&logo=scikitlearn&logoColor=white)

`Classification` `Regression` `Clustering` `Association Rules` `Gradient Boosting` `Model Evaluation` `Cross Validation` `Hyperparameter Tuning`
...
<a href="mailto:mahmoudafadl5@gmail.com">
